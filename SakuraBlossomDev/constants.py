...
WHATSAPP_NUMBER = os.getenv("WHATSAPP_NUMBER") # Obtiene el valor de la variable de entorno
...
WHATSAPP_URL = f"https://wa.me/{WHATSAPP_NUMBER}" #Ejemplo: "https://wa.me/521234567890"
import reflex as rx
from Sakbyte.constants import SAKURA_COLOR_URL
...
def footer() -> rx.Component:
    return rx.vstack(
        ...
        rx.image(src="/ico/logo.ico", width="40px", alt="Cherry blossom"),
        
        # Texto que muestra un rango de años desde 2024 hasta el año actual
        rx.text(f"2024-{datetime.date.today().year} Sakbyte V4"),
